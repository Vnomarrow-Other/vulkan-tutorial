...
impl App {
    ...
    /// Updates the uniform buffer object for our Vulkan app. (The uniform buffer are applied to all models)
...
fn load_model(instance: &Instance, device: &Device, data: &mut AppData, path: &str) -> Result<()> {
    // Model
